...
Таблицы в БД: Автомойки, услуги, цены на услуги, типы кузова. Представление с выводом всей информации.

Можно добавить каждый параметр отдельно или задать услугу со всеми параметрами. (Параметры: филиал автомойки, наименовании услуги, стоимость, тип кузова авто)
